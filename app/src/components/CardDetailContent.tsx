...
function CardImageGallery({ variants, currentCardId, onAltImageClick }: CardImageGalleryProps) {
  const { english, japanese } = groupImagesByLanguage(variants, currentCardId)
    ...
    <>
      ...
      {cardVariants.length > 0 && (
        <div className="mt-4">
          ...
          <CardImageGallery variants={cardVariants} currentCardId={card.id} onAltImageClick={onAltImageClick} />
        </div>
      )}
