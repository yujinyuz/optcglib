  ...
  return (
    ...
    >
      ...
      {(!showImages && card.counter !== null) && (
        <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center bg-slate-900 dark:bg-black px-0.5 py-3 rounded-r shadow-sm">
          <span
            className="text-[7px] font-bold text-white tracking-wider leading-tight"
            style={{ writingMode: 'vertical-lr', textOrientation: 'mixed', transform: 'rotate(180deg)' }}
          >
            <span style={{ display: 'inline-block', transform: 'rotate(180deg)' }}>⚡</span>COUNTER +{card.counter}
          </span>
        </div>
      )}
